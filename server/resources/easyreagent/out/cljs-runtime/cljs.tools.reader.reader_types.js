...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_28116 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_28116(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_28117 = (function (reader){
var x__5390__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_28117(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_28118 = (function (reader,ch){
var x__5390__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_28118(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_28122 = (function (reader){
var x__5390__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_28122(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_28123 = (function (reader){
var x__5390__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_28123(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_28124 = (function (reader){
var x__5390__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_28124(reader);
}
});
...
var G__28139 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
var G__28140 = s.append(c);
c = G__28139;
s = G__28140;
continue;
}
