...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),(function (){var iter__5520__auto__ = (function easyreagent$components$global_state_component_$_iter__40754(s__40755){
return (new cljs.core.LazySeq(null,(function (){
var s__40755__$1 = s__40755;
while(true){
var temp__5823__auto__ = cljs.core.seq(s__40755__$1);
if(temp__5823__auto__){
var s__40755__$2 = temp__5823__auto__;
if(cljs.core.chunked_seq_QMARK_(s__40755__$2)){
var c__5518__auto__ = cljs.core.chunk_first(s__40755__$2);
var size__5519__auto__ = cljs.core.count(c__5518__auto__);
var b__40757 = cljs.core.chunk_buffer(size__5519__auto__);
if((function (){var i__40756 = (0);
while(true){
if((i__40756 < size__5519__auto__)){
var elt = cljs.core._nth(c__5518__auto__,i__40756);
cljs.core.chunk_append(b__40757,elt);

var G__40807 = (i__40756 + (1));
i__40756 = G__40807;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__40757),easyreagent$components$global_state_component_$_iter__40754(cljs.core.chunk_rest(s__40755__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__40757),null);
}
} else {
var elt = cljs.core.first(s__40755__$2);
return cljs.core.cons(elt,easyreagent$components$global_state_component_$_iter__40754(cljs.core.rest(s__40755__$2)));
}
} else {
return null;
}
...
var new_elt_40808 = document.createElement("div");
(new_elt_40808.id = easyreagent.components.easyreagent_global_elements_id);

document.body.appendChild(new_elt_40808);
...
var fexpr__40761_40810 = new cljs.core.Keyword(null,"on-enter","on-enter",-928988216).cljs$core$IFn$_invoke$arity$1(attr_map);
(fexpr__40761_40810.cljs$core$IFn$_invoke$arity$0 ? fexpr__40761_40810.cljs$core$IFn$_invoke$arity$0() : fexpr__40761_40810.call(null, ));
...
var G__40758 = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(attr_map);
var result__38276__auto__ = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (val){
return cljs.core.reset_BANG_(curr_value_atom,val.target.value);
}),new cljs.core.Keyword(null,"on-key-down","on-key-down",-1374733765),(function (event){
if(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((13),event.keyCode)) && ((!((new cljs.core.Keyword(null,"on-enter","on-enter",-928988216).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(G__40758)) == null)))))){
var fexpr__40762_40811 = new cljs.core.Keyword(null,"on-enter","on-enter",-928988216).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(G__40758));
(fexpr__40762_40811.cljs$core$IFn$_invoke$arity$0 ? fexpr__40762_40811.cljs$core$IFn$_invoke$arity$0() : fexpr__40762_40811.call(null, ));
...
if((!(cljs.core.fn_QMARK_(result__38276__auto__)))){
return easyreagent.create_component.with_attr_map(attr_map,result__38276__auto__);
} else {
return (function (attr_map__$1,curr_value_atom__$1){
cljs.core.reset_BANG_(G__40758,attr_map__$1);

return easyreagent.create_component.with_attr_map(attr_map__$1,cljs.core.apply.cljs$core$IFn$_invoke$arity$2(result__38276__auto__,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [curr_value_atom__$1], null)));
});
}
}));
...
var fexpr__40766 = new cljs.core.Keyword(null,"additional-on-change","additional-on-change",228616361).cljs$core$IFn$_invoke$arity$1(attr_map);
return (fexpr__40766.cljs$core$IFn$_invoke$arity$0 ? fexpr__40766.cljs$core$IFn$_invoke$arity$0() : fexpr__40766.call(null, ));
} else {
return null;
}
}),new cljs.core.Keyword(null,"on-key-down","on-key-down",-1374733765),(function (event){
if(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((13),event.keyCode)) && ((!((new cljs.core.Keyword(null,"on-enter","on-enter",-928988216).cljs$core$IFn$_invoke$arity$1(attr_map) == null)))))){
var fexpr__40767_40813 = new cljs.core.Keyword(null,"on-enter","on-enter",-928988216).cljs$core$IFn$_invoke$arity$1(attr_map);
(fexpr__40767_40813.cljs$core$IFn$_invoke$arity$0 ? fexpr__40767_40813.cljs$core$IFn$_invoke$arity$0() : fexpr__40767_40813.call(null, ));
...
var G__40763 = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(attr_map);
var result__38276__auto__ = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"textarea","textarea",-650375824),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (val){
cljs.core.reset_BANG_(curr_value_atom,val.target.value);

if((!((new cljs.core.Keyword(null,"additional-on-change","additional-on-change",228616361).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(G__40763)) == null)))){
var fexpr__40768 = new cljs.core.Keyword(null,"additional-on-change","additional-on-change",228616361).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(G__40763));
return (fexpr__40768.cljs$core$IFn$_invoke$arity$0 ? fexpr__40768.cljs$core$IFn$_invoke$arity$0() : fexpr__40768.call(null, ));
} else {
return null;
}
}),new cljs.core.Keyword(null,"on-key-down","on-key-down",-1374733765),(function (event){
if(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((13),event.keyCode)) && ((!((new cljs.core.Keyword(null,"on-enter","on-enter",-928988216).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(G__40763)) == null)))))){
var fexpr__40769_40814 = new cljs.core.Keyword(null,"on-enter","on-enter",-928988216).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(G__40763));
(fexpr__40769_40814.cljs$core$IFn$_invoke$arity$0 ? fexpr__40769_40814.cljs$core$IFn$_invoke$arity$0() : fexpr__40769_40814.call(null, ));
...
return (function (attr_map__$1,curr_value_atom__$1){
cljs.core.reset_BANG_(G__40763,attr_map__$1);
...
var G__40770 = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(attr_map);
var result__38276__auto__ = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),"checkbox",new cljs.core.Keyword(null,"checked","checked",-50955819),cljs.core.deref(is_checked_atom),new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(is_checked_atom,cljs.core.not);
})], null)], null);
if((!(cljs.core.fn_QMARK_(result__38276__auto__)))){
return easyreagent.create_component.with_attr_map(attr_map,result__38276__auto__);
...
cljs.core.reset_BANG_(G__40770,attr_map__$1);

return easyreagent.create_component.with_attr_map(attr_map__$1,cljs.core.apply.cljs$core$IFn$_invoke$arity$2(result__38276__auto__,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [is_checked_atom__$1], null)));
});
}
}));
...
var G__40773 = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(attr_map);
var result__38276__auto__ = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"type","type",1174270348),"range",new cljs.core.Keyword(null,"min","min",444991522),min,new cljs.core.Keyword(null,"max","max",61366548),max,new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(current_value_atom),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"float","float",-1732389368),"left",new cljs.core.Keyword(null,"width","width",-384071477),"100%",new cljs.core.Keyword(null,"margin-top","margin-top",392161226),(3)], null),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (val){
return cljs.core.reset_BANG_(current_value_atom,val.target.value);
})], null)], null);
if((!(cljs.core.fn_QMARK_(result__38276__auto__)))){
return easyreagent.create_component.with_attr_map(attr_map,result__38276__auto__);
...
cljs.core.reset_BANG_(G__40773,attr_map__$1);

return easyreagent.create_component.with_attr_map(attr_map__$1,cljs.core.apply.cljs$core$IFn$_invoke$arity$2(result__38276__auto__,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [current_value_atom__$1,min__$1,max__$1], null)));
});
}
}));
...
var fexpr__40776 = new cljs.core.Keyword(null,"on-ended","on-ended",428118347).cljs$core$IFn$_invoke$arity$1(attr_map);
return (fexpr__40776.cljs$core$IFn$_invoke$arity$0 ? fexpr__40776.cljs$core$IFn$_invoke$arity$0() : fexpr__40776.call(null, ));
} else {
return null;
}
} else {
...
var G__40777 = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(attr_map);
var result__38276__auto__ = (function (){var curr_time = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(Date.now());
var time_ended = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false);
setInterval((function (){
return easyreagent.components.reset_timer_and_check_end(curr_time,end_time,time_ended,cljs.core.deref(G__40777));
}),(100));
...
cljs.core.reset_BANG_(G__40777,attr_map__$1);

return easyreagent.create_component.with_attr_map(attr_map__$1,cljs.core.apply.cljs$core$IFn$_invoke$arity$2(result__38276__auto__,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [end_time__$1], null)));
});
}
}));
...
var fexpr__40783 = new cljs.core.Keyword(null,"is-timer-paused","is-timer-paused",-2007418263).cljs$core$IFn$_invoke$arity$1(attr_map);
return (fexpr__40783.cljs$core$IFn$_invoke$arity$0 ? fexpr__40783.cljs$core$IFn$_invoke$arity$0() : fexpr__40783.call(null, ));
} else {
...
var fexpr__40784_40823 = new cljs.core.Keyword(null,"on-ended","on-ended",428118347).cljs$core$IFn$_invoke$arity$1(attr_map);
(fexpr__40784_40823.cljs$core$IFn$_invoke$arity$0 ? fexpr__40784_40823.cljs$core$IFn$_invoke$arity$0() : fexpr__40784_40823.call(null, ));
...
var G__40780 = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(attr_map);
var result__38276__auto__ = (function (){var start_time = Date.now();
var time_ended = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false);
setInterval((function (){
if((((cljs.core.deref(secs_left) > (0))) && (cljs.core.not((function (){var and__5041__auto____$1 = new cljs.core.Keyword(null,"is-timer-paused","is-timer-paused",-2007418263).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(G__40780));
if(cljs.core.truth_(and__5041__auto____$1)){
var fexpr__40785 = new cljs.core.Keyword(null,"is-timer-paused","is-timer-paused",-2007418263).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(G__40780));
return (fexpr__40785.cljs$core$IFn$_invoke$arity$0 ? fexpr__40785.cljs$core$IFn$_invoke$arity$0() : fexpr__40785.call(null, ));
} else {
return and__5041__auto____$1;
}
})())))){
...
if(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(secs_left),(0))) && (((cljs.core.not(cljs.core.deref(time_ended))) && ((!((new cljs.core.Keyword(null,"on-ended","on-ended",428118347).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(G__40780)) == null)))))))){
var fexpr__40786_40824 = new cljs.core.Keyword(null,"on-ended","on-ended",428118347).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(G__40780));
(fexpr__40786_40824.cljs$core$IFn$_invoke$arity$0 ? fexpr__40786_40824.cljs$core$IFn$_invoke$arity$0() : fexpr__40786_40824.call(null, ));
...
cljs.core.reset_BANG_(G__40780,attr_map__$1);

return easyreagent.create_component.with_attr_map(attr_map__$1,cljs.core.apply.cljs$core$IFn$_invoke$arity$2(result__38276__auto__,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [secs_left__$1], null)));
});
}
}));
...
var len__5766__auto___40825 = arguments.length;
var i__5767__auto___40826 = (0);
while(true){
if((i__5767__auto___40826 < len__5766__auto___40825)){
args__5772__auto__.push((arguments[i__5767__auto___40826]));

var G__40827 = (i__5767__auto___40826 + (1));
i__5767__auto___40826 = G__40827;
continue;
} else {
}
break;
...
return (function() { 
var G__40828__delegate = function (options__$1,is_shown__$1,body__$1){
...
var G__40828 = function (options__$1,is_shown__$1,var_args){
var body__$1 = null;
if (arguments.length > 2) {
var G__40829__i = 0, G__40829__a = new Array(arguments.length -  2);
while (G__40829__i < G__40829__a.length) {G__40829__a[G__40829__i] = arguments[G__40829__i + 2]; ++G__40829__i;}
  body__$1 = new cljs.core.IndexedSeq(G__40829__a,0,null);
} 
return G__40828__delegate.call(this,options__$1,is_shown__$1,body__$1);};
G__40828.cljs$lang$maxFixedArity = 2;
G__40828.cljs$lang$applyTo = (function (arglist__40830){
var options__$1 = cljs.core.first(arglist__40830);
arglist__40830 = cljs.core.next(arglist__40830);
var is_shown__$1 = cljs.core.first(arglist__40830);
var body__$1 = cljs.core.rest(arglist__40830);
return G__40828__delegate(options__$1,is_shown__$1,body__$1);
});
...
/** @this {Function} */
(easyreagent.components.popup_window.cljs$lang$applyTo = (function (seq40787){
var G__40788 = cljs.core.first(seq40787);
var seq40787__$1 = cljs.core.next(seq40787);
var G__40789 = cljs.core.first(seq40787__$1);
var seq40787__$2 = cljs.core.next(seq40787__$1);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40788,G__40789,seq40787__$2);
}));
...
})], null),content__$1,(cljs.core.truth_(cljs.core.deref(is_shown))?(function (){var position_map = (function (){var G__40799 = new cljs.core.Keyword(null,"anchor-position","anchor-position",379564665).cljs$core$IFn$_invoke$arity$1(attr_map);
...
var G__40796 = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(attr_map);
var result__38276__auto__ = (function (){var is_shown = (function (){var or__5043__auto__ = new cljs.core.Keyword(null,"is-shown","is-shown",-1781593754).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(G__40796));
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false);
...
if(((cljs.core.not(cljs.core.deref(is_shown))) && (cljs.core.not(new cljs.core.Keyword(null,"is-shown","is-shown",-1781593754).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(G__40796)))))){
return cljs.core.reset_BANG_(is_shown,true);
} else {
return null;
}
})], null),content__$1,(cljs.core.truth_(cljs.core.deref(is_shown))?(function (){var position_map = (function (){var G__40801 = new cljs.core.Keyword(null,"anchor-position","anchor-position",379564665).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(G__40796));
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.er-modal-info-text-wrapper","div.er-modal-info-text-wrapper",-924881075),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"position","position",-2011731912),"fixed",new cljs.core.Keyword(null,"z-index","z-index",1892827090),(10)], null),position_map], 0))], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),(function (){var G__40802 = new cljs.core.Keyword(null,"anchor-position","anchor-position",379564665).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(G__40796));
...
cljs.core.reset_BANG_(G__40796,attr_map__$1);

return easyreagent.create_component.with_attr_map(attr_map__$1,cljs.core.apply.cljs$core$IFn$_invoke$arity$2(result__38276__auto__,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [description__$1,content__$1], null)));
});
}
}));
...
var args__5772__auto__ = [];
var len__5766__auto___40840 = arguments.length;
var i__5767__auto___40841 = (0);
while(true){
if((i__5767__auto___40841 < len__5766__auto___40840)){
args__5772__auto__.push((arguments[i__5767__auto___40841]));

var G__40842 = (i__5767__auto___40841 + (1));
i__5767__auto___40841 = G__40842;
continue;
} else {
}
break;
...
/** @this {Function} */
(easyreagent.components.heroed_content.cljs$lang$applyTo = (function (seq40803){
var self__5752__auto__ = this;
return self__5752__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq40803));
}));
...
var G__40804 = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(attr_map);
var result__38276__auto__ = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.core.adapt_react_class(shadow.js.shim.module$react_phone_number_input$default),new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"e.g. 321 456 7890",new cljs.core.Keyword(null,"class","class",-2030961996),"input input-bordered input-sm w-full phone-input",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(phone_number_atom),new cljs.core.Keyword(null,"defaultCountry","defaultCountry",944120324),"US",new cljs.core.Keyword(null,"addInternationalOption","addInternationalOption",-923939129),false,new cljs.core.Keyword(null,"countries","countries",863192750),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["US"], null),new cljs.core.Keyword(null,"onChange","onChange",-312891301),(function (val){
return cljs.core.reset_BANG_(phone_number_atom,val);
})], null)], null);
if((!(cljs.core.fn_QMARK_(result__38276__auto__)))){
return easyreagent.create_component.with_attr_map(attr_map,result__38276__auto__);
...
cljs.core.reset_BANG_(G__40804,attr_map__$1);

return easyreagent.create_component.with_attr_map(attr_map__$1,cljs.core.apply.cljs$core$IFn$_invoke$arity$2(result__38276__auto__,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [phone_number_atom__$1], null)));
});
}
}));
