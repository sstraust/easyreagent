...
var G__28002 = o;
reagent.impl.template.goog$module$goog$object.set(G__28002,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
return (function() { 
var G__28025__delegate = function (args){
...
while (G__28026__i < G__28026__a.length) {G__28026__a[G__28026__i] = arguments[G__28026__i + 0]; ++G__28026__i;}
  args = new cljs.core.IndexedSeq(G__28026__a,0,null);
} 
return G__28025__delegate.call(this,args);};
...
return G__28025__delegate(args);
});
...
var G__28008 = o;
reagent.impl.template.goog$module$goog$object.set(G__28008,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__28028__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__28029__i < G__28029__a.length) {G__28029__a[G__28029__i] = arguments[G__28029__i + 0]; ++G__28029__i;}
  args = new cljs.core.IndexedSeq(G__28029__a,0,null);
} 
return G__28028__delegate.call(this,args);};
G__28028.cljs$lang$maxFixedArity = 0;
G__28028.cljs$lang$applyTo = (function (arglist__28030){
var args = cljs.core.seq(arglist__28030);
return G__28028__delegate(args);
});
...
var G__28009 = props;
var G__28009__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__28009,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__28009);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__28009__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5043__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__28010 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__28010,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__28010;
}
})(),id_class);
...
var G__28011 = (cljs.core.count(argv) - first_child);
switch (G__28011) {
case (0):
...
var vec__28012 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28012,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28012,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28012,(2),null);
...
var temp__5827__auto___28036 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___28036 == null)){
} else {
var key_28037 = temp__5827__auto___28036;
(jsprops.key = key_28037);
}
...
var temp__5827__auto___28038 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___28038 == null)){
} else {
var key_28039 = temp__5827__auto___28038;
(jsprops.key = key_28039);
}
...
var temp__5827__auto___28040 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5827__auto___28040 == null)){
} else {
var key_28041 = temp__5827__auto___28040;
(jsprops.key = key_28041);
}
...
var temp__5827__auto___28044 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___28044 == null)){
} else {
var key_28045 = temp__5827__auto___28044;
(jsprops.key = key_28045);
}
...
var temp__5827__auto___28046 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___28046 == null)){
} else {
var key_28047 = temp__5827__auto___28046;
(jsprops.key = key_28047);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28015_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__28015_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__28016 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28016,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28016,(1),null);
...
break;
default:
var G__28052 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__28053 = compiler;
v = G__28052;
compiler = G__28053;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template28022 = (function (opts,id,fn_to_element,parse_fn,meta28023){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template28022.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_28024,meta28023__$1){
var self__ = this;
var _28024__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template28022(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta28023__$1));
}));

(reagent.impl.template.t_reagent$impl$template28022.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_28024){
var self__ = this;
var _28024__$1 = this;
return self__.meta28023;
}));

(reagent.impl.template.t_reagent$impl$template28022.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template28022.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template28022.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template28022.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template28022.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template28022.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta28023","meta28023",2045292929,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template28022.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template28022.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template28022");

(reagent.impl.template.t_reagent$impl$template28022.cljs$lang$ctorPrWriter = (function (this__5327__auto__,writer__5328__auto__,opt__5329__auto__){
return cljs.core._write(writer__5328__auto__,"reagent.impl.template/t_reagent$impl$template28022");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template28022.
 */
reagent.impl.template.__GT_t_reagent$impl$template28022 = (function reagent$impl$template$__GT_t_reagent$impl$template28022(opts,id,fn_to_element,parse_fn,meta28023){
return (new reagent.impl.template.t_reagent$impl$template28022(opts,id,fn_to_element,parse_fn,meta28023));
});
...
return (new reagent.impl.template.t_reagent$impl$template28022(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
