...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__27969 = c;
var G__27969__$1 = (((G__27969 == null))?null:G__27969.prototype);
if((G__27969__$1 == null)){
return null;
} else {
return G__27969__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__27970 = c;
var G__27970__$1 = (((G__27970 == null))?null:G__27970.prototype);
if((G__27970__$1 == null)){
return null;
} else {
return G__27970__$1.render;
}
})() == null)))));
});
...
var or__5043__auto__ = (function (){var G__27972 = c;
var G__27972__$1 = (((G__27972 == null))?null:G__27972.constructor);
if((G__27972__$1 == null)){
return null;
} else {
return G__27972__$1.displayName;
}
})();
...
var G__27973 = c;
var G__27973__$1 = (((G__27973 == null))?null:G__27973.constructor);
if((G__27973__$1 == null)){
return null;
} else {
return G__27973__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__27974 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__27975 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__27975);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__27974);
}});
...
var c = this;
var G__27978_27998 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__27978_27998 == null)){
} else {
reagent.ratom.dispose_BANG_(G__27978_27998);
}
...
var renders_27999 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_28000 = cljs.core.first(cljs.core.vals(renders_27999));
...
if((cljs.core.count(renders_27999) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_27999))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_28000)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_28000], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__27979 = o;
reagent.impl.component.goog$module$goog$object.set(G__27979,cljs.core.name(k),v);
...
while (G__28004__i < G__28004__a.length) {G__28004__a[G__28004__i] = arguments[G__28004__i + 0]; ++G__28004__i;}
  args = new cljs.core.IndexedSeq(G__28004__a,0,null);
} 
...
var _STAR_current_component_STAR__orig_val__27980 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__27981 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__27981);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__27980);
}});
...
var vec__27982 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27982,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27982,(1),null);
...
var G__27985 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__27985 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__27985);
}
});
}),[]);
