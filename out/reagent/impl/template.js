...
var G__9157 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__9157,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__9161 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__9161,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__9163__i < G__9163__a.length) {G__9163__a[G__9163__i] = arguments[G__9163__i + 0]; ++G__9163__i;}
  args = new cljs.core.IndexedSeq(G__9163__a,0,null);
} 
...
var G__9165 = props;
var G__9165__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__9165,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__9165);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__9165__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__5043__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__9166 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__9166,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__9166;
}
})(),id_class);
...
var G__9167 = (cljs.core.count.call(null,argv) - first_child);
switch (G__9167) {
case (0):
...
var vec__9169 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__9169,(0),null);
var id = cljs.core.nth.call(null,vec__9169,(1),null);
var className = cljs.core.nth.call(null,vec__9169,(2),null);
...
var temp__5461__auto___9172 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5461__auto___9172 == null)){
} else {
var key_9173 = temp__5461__auto___9172;
(jsprops.key = key_9173);
}
...
var temp__5461__auto___9174 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5461__auto___9174 == null)){
} else {
var key_9175 = temp__5461__auto___9174;
(jsprops.key = key_9175);
}
...
var temp__5461__auto___9176 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5461__auto___9176 == null)){
} else {
var key_9177 = temp__5461__auto___9176;
(jsprops.key = key_9177);
}
...
var temp__5461__auto___9178 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5461__auto___9178 == null)){
} else {
var key_9179 = temp__5461__auto___9178;
(jsprops.key = key_9179);
}
...
var temp__5461__auto___9180 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5461__auto___9180 == null)){
} else {
var key_9181 = temp__5461__auto___9180;
(jsprops.key = key_9181);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__9182_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__9182_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__9183 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__9183,(0),null);
var derefed = cljs.core.nth.call(null,vec__9183,(1),null);
...
break;
default:
var G__9188 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__9189 = compiler;
v = G__9188;
compiler = G__9189;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template9193 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template9193 = (function (opts,id,fn_to_element,parse_fn,meta9194){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template9193.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_9195,meta9194__$1){
var self__ = this;
var _9195__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template9193(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta9194__$1));
}));

(reagent.impl.template.t_reagent$impl$template9193.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_9195){
var self__ = this;
var _9195__$1 = this;
return self__.meta9194;
}));

(reagent.impl.template.t_reagent$impl$template9193.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template9193.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template9193.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reagent$impl$template9193.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template9193.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template9193.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta9194","meta9194",148822498,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template9193.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template9193.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template9193");

(reagent.impl.template.t_reagent$impl$template9193.cljs$lang$ctorPrWriter = (function (this__5327__auto__,writer__5328__auto__,opt__5329__auto__){
return cljs.core._write.call(null,writer__5328__auto__,"reagent.impl.template/t_reagent$impl$template9193");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template9193.
 */
reagent.impl.template.__GT_t_reagent$impl$template9193 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template9193(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta9194){
return (new reagent.impl.template.t_reagent$impl$template9193(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta9194));
});

}

return (new reagent.impl.template.t_reagent$impl$template9193(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
